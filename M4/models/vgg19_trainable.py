...
class Vgg19:
	...
	######################################################
    def inference_graph(self, rgb, train_mode=None, image_pixels = 224*224, num_classes = 2):
	
        rgb_scaled = rgb * 255.0
        
        ### Dimension info: images_reshaped shape: expected to be [100, 60, 80, 1]
        rgb_reshaped = tf.reshape(rgb_scaled, [-1,224,224,3])
        ...
        self.fc8 = self.fc_layer(self.relu7, 4096, 2, "fc8_modified", trainable=True)
