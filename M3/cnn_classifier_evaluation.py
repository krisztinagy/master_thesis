...
flags.DEFINE_string('model_dir', 'cnn-e%d/' % cfg.hyperparameters['num_epochs'], 'Directory for storing model and results')
...
def run_evaluation():
	...
	with treedom_graph.as_default():
	    ...
	    logits = model.inference_graph(images_placeholder, True, FLAGS.image_pixels, FLAGS.num_classes)
