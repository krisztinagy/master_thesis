...
flags.DEFINE_string('train_dir','train-' + str(int(cfg.dataset['size'] * cfg.dataset['train_ratio'])) + '-test-' + str(int(cfg.dataset['size'] * cfg.dataset['test_ratio'])) + '/' + cfg.directory['output'] + '/', 'Directory with the training data.')
