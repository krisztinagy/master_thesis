...
flags.DEFINE_string('model_dir', 'vgg-e%d/' % cfg.hyperparameters['num_epochs'], 'Directory for storing model and results')
...
def run_training():
    ...
    with treedom_graph.as_default():
        ...
        writer = tf.summary.FileWriter(tensorboard_dir, treedom_graph)
...
shutil.copy2('/home/nagy729krisztina/M4/config.py', directory)
