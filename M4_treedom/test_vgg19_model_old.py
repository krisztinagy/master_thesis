...
def run_evaluation():
	...
	with graph.as_default():
	    ...
	    network = model.Vgg19("vgg19.npy", trainable=False)
        logits = network.inference_graph(images_placeholder, False, FLAGS.image_pixels, FLAGS.num_classes)
...
f.write('\n\n----CNN CLASSIFICATION based on VGG net EVALUATION----\n\n')
